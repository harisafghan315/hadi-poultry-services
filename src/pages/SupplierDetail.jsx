...
export default function SupplierDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Broker-model stats: Hadi Poultry is a middleman, not a stockist.
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs text-slate-600 leading-relaxed">
        <span className="font-semibold text-slate-700">Broker view</span> — Hadi Poultry doesn't receive Dana from this meel.
