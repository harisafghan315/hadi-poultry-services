...
export default function QuickEntryModal({ open, onClose, onCreated, editEntry = null }) {
  ...
  // the Saraf, not directly to Hadi Poultry).
        ...
        {type === 'bill' && (() => {
          ...
          return (
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-400">No inventory is touched — Hadi Poultry only writes the bill. Client picks up Dana from the meel directly; settlement happens via Saraf.</p>
            </div>
          )
        })()}
