-- ============================================================
-- HADI POULTRY SERVICES — Full Database Setup
-- Generated from Hadi Poultry schema (schema.sql + migrations 010, 011)
-- Run ONCE in the new Supabase project: SQL Editor → paste → Run.
-- Idempotent: safe to re-run. Creates a clean, empty database.
-- ============================================================
...
-- ============================================================
-- Saraf (money exchanger) — Hadi Poultry only
-- ============================================================
...
-- ============================================================
-- Migration 010: Saraf payment ↔ bill (supplier_dispatch) link
-- ============================================================
...
-- ============================================================
-- Migration 011: supplier_payment ↔ farm link
-- ============================================================
...
-- ============================================================
-- Hadi Poultry Services — business name (drives sidebar, tab title, WhatsApp)
-- ============================================================
INSERT INTO settings (key, value) VALUES ('business_name', 'Hadi Poultry Services')
ON CONFLICT (key) DO NOTHING;
